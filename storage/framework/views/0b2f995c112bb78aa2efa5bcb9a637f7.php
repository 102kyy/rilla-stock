...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('assets/images/rillacumacrame.png')); ?>">
    ...
    <aside class="navbar navbar-vertical navbar-expand-lg navbar-light bg-white border-end">
        <div class="container-fluid">
            ...
            <div class="navbar-brand py-4">
                <a href=".">
                    <img src="<?php echo e(asset('assets/images/rillacumacrame.png')); ?>" style="height: 70px; width: auto; object-fit: contain;" alt="Rilla Stock">
                </a>
            </div>
...
</html> --><?php /**PATH C:\laragon\www\rilla-stock\resources\views/welcome.blade.php ENDPATH**/ ?>