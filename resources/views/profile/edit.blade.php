                ...
                <div class="card" style="border-radius: 24px; border: none; box-shadow: 0 10px 30px rgba(109, 76, 65, 0.08); overflow: hidden; background: #ffffff;">
                    ...
                    <div class="card-body text-center py-5">
                        <div class="position-relative d-inline-block mb-3">
                            <span class="avatar avatar-xl" style="background: linear-gradient(135deg, {{ $user->isAdmin() ? '#6d4c41' : '#ba9778' }}, {{ $user->isAdmin() ? '#8d6e63' : '#d7ccc8' }}); color: white; font-size: 1.5rem; box-shadow: 0 8px 22px rgba(109, 76, 65, 0.18); width: 90px; height: 90px; border-radius: 28px;">
                        ...
                        <span class="badge rounded-pill px-3 py-2" style="background-color: #fff1e6; color: #6d4c41; border: 1px solid #ebdcd0; font-size: 0.75rem;">{{ ucfirst($user->role) }} Account</span>
                        <p class="text-muted small mt-3 mb-0"><i class="ti ti-fingerprint me-1"></i>{{ $user->email }}</p>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="p-3 h-100 rounded-4" style="background: #fdfaf7; border: 1px solid #f3e8de;">
                                    ...
                                    <div class="fw-bold" style="color: #4e342e;">{{ $user->name }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="p-3 h-100 rounded-4" style="background: #fdfaf7; border: 1px solid #f3e8de;">
                                    <div class="text-muted small mb-1" style="font-size: 0.75rem;">Email Resmi</div>
                                    <div class="fw-bold" style="color: #4e342e;">{{ $user->email }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="p-3 h-100 rounded-4" style="background: #fdfaf7; border: 1px solid #f3e8de;">
                                    <div class="text-muted small mb-1" style="font-size: 0.75rem;">Level Otoritas</div>
                                    <div class="fw-bold" style="color: #4e342e;">{{ ucfirst($user->role) }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="p-3 h-100 rounded-4" style="background: #fdfaf7; border: 1px solid #f3e8de;">
