        ...
        <div class="navbar-nav flex-row order-md-last ms-auto">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm shadow-sm" style="background-image: url(https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=ba9778&color=fff)"></span>
                    <div class="d-none d-xl-block ps-2 text-start">
                        <div class="fw-bold">{{ Auth::user()->name }}</div>
                        <div class="mt-1 small text-muted" style="font-size: 0.7rem;">{{ ucfirst(Auth::user()->role) }} Rilla Stock</div>
                    </div>
                </a>
