    ...
    <div class="container-fluid">
        <div class="navbar-brand py-4">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('assets/images/rillacumacrame.png') }}" style="height: 80px; filter: drop-shadow(0 2px 4px rgba(186, 151, 120, 0.2));" alt="Rilla Stock">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav">
                ...
                <li class="nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('dashboard') }}">
                ...
                <li class="nav-item {{ request()->routeIs('produk.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('produk.index') }}">
                        <span class="nav-link-icon" style="color: #8d6e63;"><i class="ti ti-box"></i></span>
                        <span class="nav-link-title">Daftar Produk</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->routeIs('bahan-baku.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('bahan-baku.index') }}">
                ...
                <li class="nav-item {{ request()->routeIs('kategori.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('kategori.index') }}">
                ...
                <li class="nav-item {{ request()->routeIs('supplier.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('supplier.index') }}">
                ...
                <li class="nav-item {{ Auth::user()->isAdmin() ? 'mt-2' : '' }}">
                    <div class="px-3 py-3 small fw-bold text-uppercase" style="letter-spacing: 1px; font-size: 0.65rem; color: #ba9778;">Transaksi</div>
                </li>
                <li class="nav-item {{ request()->is('stok-masuk*') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('stok-masuk.index') }}">
                        <span class="nav-link-icon text-success"><i class="ti ti-circle-arrow-down"></i></span>
                        <span class="nav-link-title">Stok Masuk</span>
                    </a>
                </li>
                <li class="nav-item {{ request()->is('stok-keluar*') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('stok-keluar.index') }}">
                ...
                <li class="nav-item {{ request()->routeIs('laporan.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('laporan.index') }}">
                ...
                <li class="nav-item {{ request()->routeIs('user.index') ? 'active' : '' }}">
                    <a class="nav-link side-link" href="{{ route('user.index') }}">
