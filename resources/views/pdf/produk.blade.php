...
<body>
    ...
    <div class="header-section">
        ...
        <div class="meta-block">
            Tanggal Dokumen: {{ date('d/m/Y') }} &bull; Rilla-Stock Inventory System
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            @php $totalStok += $p->stok_akhir; @endphp
            <tr>
                <td class="text-center" style="color: #999999;">{{ $index + 1 }}</td>
                ...
                <td class="text-center fw-bold">{{ $p->stok_akhir }}</td>
            </tr>
            @endforeach
            
            <tr class="total-box-row">
                <td colspan="3" class="text-center">TOTAL UNIT STOK</td>
                <td colspan="2" class="text-center">{{ $totalStok }} Pcs</td>
            </tr>
        </tbody>
    </table>
