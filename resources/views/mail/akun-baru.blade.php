        ...
        <div class="email-body">
            ...
            <div class="account-box">
                <ul class="account-details">
                    ...
                    <li><strong>Password:</strong> <span style="font-family: monospace; background: #e0d4c8; padding: 2px 6px; border-radius: 4px; font-weight: bold;">{{ $password }}</span></li>
                </ul>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="{{ url('/login') }}" class="btn-login">Masuk ke Aplikasi</a>
            </div>
        </div>
        <div class="email-footer">
            <p>Pemberitahuan otomatis oleh Sistem Inventaris Rilla Stock.<br>
            &copy; {{ date('Y') }} Rillakumacrame. All Rights Reserved.</p>
        </div>
    </div>
